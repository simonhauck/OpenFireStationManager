...
@Component
class V021AddMemberToClothingLocations : DatabaseMigration {
    override val id = "V021__add_member_to_clothing_locations"
    ...
    override fun execute(jdbcTemplate: JdbcTemplate) {
        ...
        jdbcTemplate.execute("DROP VIEW IF EXISTS resolved_clothing_item_view")
        ...
        jdbcTemplate.execute(
            ...
            SELECT
                ...
                c_l.member_id                AS location_member_id,
